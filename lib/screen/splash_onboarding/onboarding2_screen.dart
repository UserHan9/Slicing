...
import 'onboarding_screen.dart' show createRouteSlide;
...
Positioned(
            ...
            left: 0,
            right: 0,
            child: ClipPath( // <-- Tambahkan ClipPath di sini
              clipper: OnboardingClipPath(), // <-- Gunakan CustomClipper
              child: Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    // Perhatikan: Anda mungkin perlu menyesuaikan atau menghapus
                    // SizedBox(height: 50) karena lekukan sudah mengambil ruang.
                    const Column(
                      children: [
                        SizedBox(height: 50), 
                        Text(
